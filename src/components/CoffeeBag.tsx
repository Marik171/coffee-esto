...
export const PRODUCT_STYLES: Record<string, { bagColor: string; textColor: string; accentColor: string; illustration: React.ReactNode; emoji: string }> = {
  guatemala: {
    bagColor: '#523e3e',
    textColor: '#ffffff',
    accentColor: '#ebdada',
...
export default function CoffeeBag({ coffeeName, origin, bagColor, illustration, emoji, locale = 'en' }: CoffeeBagProps) {
